...
@CucumberOptions(features = "src/test/java/features", 				// specify where the feature files are located
		glue = "stepDefinitions" 									// specify where the stepDefinition files are located
		, plugin = { "progress", "html:target/cucumberReport.html", 	// to generate cucumber reports
